...
\begin{figure}[t]
    ...
    \includegraphics[width=\textwidth]{../../bld/out/figures/matrix_nan.png}
...
\begin{figure}[t]
    ...
    \includegraphics[width=\textwidth]{../../bld/out/figures/heatmap_nan.png}
...
\input{../../bld/out/tables/table_welch_df}
\end{adjustbox}
...
\begin{adjustbox}{width=\textwidth,totalheight=\textheight,keepaspectratio}
\input{../../bld/out/tables/table_logistic_df}
\end{adjustbox}
...
\begin{adjustbox}{width=\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../bld/out/tables/table_integrity_df}
\end{adjustbox}
