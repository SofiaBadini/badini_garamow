...
\input{../../bld/out/tables/table_gate_complete_controls_coeff}


\medskip
\begin{adjustbox}{width=0.825\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../bld/out/tables/table_gate_complete_controls_summary}
\end{adjustbox}
...
\input{../../bld/out/tables/table_data_imputed_kNN_controls_coeff}


\medskip
\begin{adjustbox}{width=0.825\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../bld/out/tables/table_data_imputed_kNN_controls_summary}
\end{adjustbox}
