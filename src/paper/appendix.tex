...
\input{../../out/tables/table_levene_df}
\end{adjustbox}
...
\begin{adjustbox}{width=\textwidth,totalheight=\textheight,keepaspectratio}
\input{../../out/tables/table_chisq_df}
\end{adjustbox}
...
\input{../../out/tables/table_gate_complete_no_controls_coeff}
\addtolength{\tabcolsep}{-24pt}

\medskip
\input{../../out/tables/table_gate_complete_no_controls_summary}
...
\input{../../out/tables/table_data_imputed_kNN_msd_controls_coeff}


\medskip
\begin{adjustbox}{width=0.825\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../out/tables/table_data_imputed_kNN_msd_controls_summary}
\end{adjustbox}
...
\centering
\caption{\textsc{ITT Estimates on log Household Income - Analysis on Imputed Data}}
\input{../../out/tables/table_data_imputed_kNN_min_controls_coeff}


\medskip
\begin{adjustbox}{width=0.825\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../out/tables/table_data_imputed_kNN_min_controls_summary}
\end{adjustbox}
...
\centering
\caption{\textsc{ITT Estimates on log Household Income - Analysis on Imputed Data}}
\input{../../out/tables/table_data_imputed_kNN_max_controls_coeff.tex}


\medskip
\begin{adjustbox}{width=0.825\textwidth, totalheight=\textheight, keepaspectratio}
\input{../../out/tables/table_data_imputed_kNN_max_controls_summary.tex}
\end{adjustbox}
